...
def main():
    parser = argparse.ArgumentParser(description="Run GliNER model on ENEIDE")
    parser.add_argument("--documents", type=str, required=True, help="Path to CSV containing documents.")
    parser.add_argument("--output_dir", type=str, default="./gliner_results", help="Path to output directory.")
