...
train_df.to_csv(os.path.join(output_path, "paragraphs_train.csv"), index=False, encoding="utf-8")
dev_df.to_csv(os.path.join(output_path, "paragraphs_dev.csv"), index=False, encoding="utf-8")
test_df.to_csv(os.path.join(output_path, "paragraphs_test.csv"), index=False, encoding="utf-8")
...
with open(os.path.join(output_path, "annotations_train.csv"), "w", encoding="utf-8") as f:
    dict_writer = csv.DictWriter(f, keys)
    dict_writer.writeheader()
    dict_writer.writerows(train_annotations)
f.close()

with open(os.path.join(output_path, "annotations_dev.csv"), "w", encoding="utf-8") as f:
    dict_writer = csv.DictWriter(f, keys)
    dict_writer.writeheader()
    dict_writer.writerows(dev_annotations)
f.close()

with open(os.path.join(output_path, "annotations_test.csv"), "w", encoding="utf-8") as f:
    dict_writer = csv.DictWriter(f, keys)
    dict_writer.writeheader()
