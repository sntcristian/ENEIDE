...
with open("../AMD/v0.1/manual_annotations.csv", "r", encoding="utf-8") as f1:
    dict_reader = csv.DictReader(f1)
    extra_annotations = list(dict_reader)
f1.close()
...
with open("../AMD/v0.1/surface_form_dict.json", "r", encoding="utf-8") as f1:
...
train_df.to_csv("./AMD/v0.1/paragraphs_train.csv", index=False, encoding="utf-8")
dev_df.to_csv("./AMD/v0.1/paragraphs_dev.csv", index=False, encoding="utf-8")
test_df.to_csv("./AMD/v0.1/paragraphs_test.csv", index=False, encoding="utf-8")
...
with open("./AMD/v0.1/annotations_train.csv", "w", encoding="utf-8") as f:
    dict_writer = csv.DictWriter(f, keys)
    dict_writer.writeheader()
    dict_writer.writerows(train_annotations)
f.close()

with open("./AMD/v0.1/annotations_dev.csv", "w", encoding="utf-8") as f:
    dict_writer = csv.DictWriter(f, keys)
    dict_writer.writeheader()
    dict_writer.writerows(dev_annotations)
f.close()

with open("./AMD/v0.1/annotations_test.csv", "w", encoding="utf-8") as f:
    dict_writer = csv.DictWriter(f, keys)
    dict_writer.writeheader()
